...
export default function Project() {
  ...
  return (
    <section id="projects" className="py-12 px-5 max-w-5xl mx-auto">
      
      {/* HEADER SECTION: TEKS DI KIRI, FILTER NAVIGATION DI KANAN */}
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
        ...
        >
          <span className="inline-block px-4 py-1 rounded-full bg-[#DCE8F6] text-[#4A8FD0] font-mono text-[11px] font-bold tracking-[0.2em]">
            MY RECENT WORKS
          </span>
              ...
              <div className="p-5 pt-0">
                <div className="pt-3 border-t border-slate-100 flex items-center gap-2">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl bg-slate-100 text-slate-700 text-xs font-semibold hover:bg-slate-200 active:scale-95 transition-all border border-slate-200/60"
